...
from aider.reasoning_tags import (REASONING_TAG, format_reasoning_content,
                                  remove_reasoning_content,
                                  replace_reasoning_tags)
from aider.repo import ANY_GIT_ERROR, GitRepo
from aider.repomap import RepoMap
from aider.run_cmd import run_cmd
from aider.utils import (format_content, format_messages, format_tokens,
                         is_image_file)
        ...
        **kwargs,
        ...
        if from_coder:
            ...
            update = dict(
                ...
                apply_prompt=from_coder.apply_prompt,
            )
